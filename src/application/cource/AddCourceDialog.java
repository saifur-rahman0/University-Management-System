...
public class AddCourceDialog extends JDialog implements ActionListener {
    ...
    public AddCourceDialog() {
        ...
        lblAddNewCource.setBackground(new Color(48, 11, 103, 105));
        ...
        addcourcebutton.setBackground(new Color(255, 255, 255, 255));
        addcourcebutton.setForeground(new Color(61, 0, 169));
        addcourcebutton.setFont(new Font("Segoe UI", Font.BOLD, 14));
        addcourcebutton.setBounds(310, 373, 139, 37);
        addcourcebutton.setBorder(new LineBorder(new Color(92, 9, 134)));
