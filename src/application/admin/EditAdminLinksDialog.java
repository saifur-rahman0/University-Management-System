...
public class EditAdminLinksDialog extends JDialog {
    ...
    public EditAdminLinksDialog(Admin a, AdminMain am) {
        ...
        lblNewLabel.setBackground(new Color(48, 11, 103, 105));
        ...
        updatelinksbutton.setForeground(new Color(61, 0, 169));
        updatelinksbutton.setBackground(new Color(255, 255, 255, 255));
        updatelinksbutton.setFont(new Font("Segoe UI", Font.BOLD, 14));
        updatelinksbutton.setBounds(403, 269, 139, 35);
        updatelinksbutton.setBorder(new LineBorder(new Color(92, 9, 134)));
