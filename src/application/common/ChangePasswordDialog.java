...
public class ChangePasswordDialog extends JDialog {
    ...
    public ChangePasswordDialog() {
        ...
        changepasswordbutton.setForeground(new Color(61, 0, 169));
        changepasswordbutton.setBackground(new Color(255, 255, 255));
        changepasswordbutton.setBounds(377, 281, 137, 33);
        changepasswordbutton.setBorder(new LineBorder(new Color(92, 9, 134)));
        ...
        oldshowbutton.setForeground(new Color(61, 0, 169));
        oldshowbutton.setFont(new Font("Segoe UI", Font.BOLD, 14));
        oldshowbutton.setBackground(new Color(255, 255, 255));
        oldshowbutton.setBorder(new LineBorder(new Color(92, 9, 134)));
        ...
        newshowbutton.setForeground(new Color(61, 0, 169));
        newshowbutton.setFont(new Font("Segoe UI", Font.BOLD, 14));
        newshowbutton.setBorder( new LineBorder(new Color(92, 9, 134)));
        newshowbutton.setBackground(new Color(255, 255, 255));
        ...
        new2showbutton.setForeground(new Color(61, 0, 169));
        new2showbutton.setFont(new Font("Segoe UI", Font.BOLD, 14));
        new2showbutton.setBorder( new LineBorder(new Color(92, 9, 134)));
        new2showbutton.setBackground(new Color(255, 255, 255));
